...
const CohereChat = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to get response from Cohere AI');
      }
      ...
      toast({
        title: "Error",
        description: "Failed to get response from Cohere AI. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
        {messages.length === 0 ? (
          <div className="text-center py-20 text-gray-500">
            ...
            <h3 className="text-lg font-medium mb-2">Start chatting with Cohere AI</h3>
            ...
            <div className="max-w-xs lg:max-w-md flex items-start space-x-2">
              ...
              <div className="p-3 rounded-2xl bg-white border border-gray-200">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">Cohere AI is thinking...</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="p-4 border-t bg-white border-gray-200">
        <form onSubmit={handleSubmit} className="flex items-center space-x-3">
          ...
          <Input
            ...
            placeholder="Ask Cohere AI anything..."
            className="flex-1"
            disabled={isLoading}
          />
          <Button
