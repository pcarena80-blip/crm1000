...
import { Brain, Send, CheckCircle, Paperclip, Smile } from "lucide-react";
...
const GeminiChat = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-purple-50 to-blue-50">
      ...
      <div className="p-4 border-b bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-purple-200">Powered by Google Gemini</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto space-y-4 p-4">
            ...
            >
              <div className="max-w-md">
                ...
                <div className={`flex items-center space-x-1 mt-1 ${message.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  ...
                  {message.role === 'user' && <CheckCircle className="w-3 h-3 text-purple-500" />}
                </div>
              </div>
            </div>
          ))
        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="max-w-md">
              <div className="p-3 rounded-2xl bg-white border border-purple-200 shadow-sm">
      ...
      {/* Message Input */}
      <div className="p-4 border-t bg-white border-purple-200">
        <div className="flex items-center space-x-3">
          ...
          <input
            ...
            className="flex-1 px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent border-purple-200 text-gray-900 placeholder-gray-500"
            disabled={isLoading}
          />
          <Button
